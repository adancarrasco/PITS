...
angular.module('mean.users')
  ...
  .controller('AssignedToCtrl', ['$scope', '$stateParams', '$location', 'Global', 'Users', 'MeanUser', 'Tasks',
    function($scope, $stateParams, $location, Global, Users, MeanUser, Tasks){
      $scope.global = Global;
      ...
      $scope.find = function() {
        ...
        Tasks.get({
          ...
          MeanUser.get({
            userId : task.assigned_to//'5428b912eb4e7d2825c9b652'
  ...
  .controller('ReportToCtrl', ['$scope', '$stateParams', '$location', 'Global', 'Users', 'Tasks', 'MeanUser',
    function($scope, $stateParams, $location, Global, Users, Tasks, MeanUser){
      $scope.global = Global;
      ...
      $scope.find = function() {
        ...
        Tasks.get({
          ...
          MeanUser.get({
            userId : task.report_to
          }, function(report_to){
            $scope.report_to = report_to;
          });
        });
      };
    }
