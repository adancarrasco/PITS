...
This application runs under the MEAN Stack, to be able to run it you need to install first the MEAN Stack prerequisites.
...
## More Information about PITS
  * Visit [adancarrasco.com](http://adancarrasco.com/).
  * Or visit my Blog [Adán Carrasco Blog](http://blog.adancarrasco.com/) for extended support.
